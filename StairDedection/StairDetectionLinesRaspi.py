...
def main(argv):
                ...
                for tempLine in tempLines:
                    ...
                    if (tempLine.offset - offset) > OFFSETBUCKET:
                        ...
                        if len(tempOffsetList) > 1:
                            newLines.append(Line(tempOffsetList[0].x1, tempOffsetList[0].y1,
                                                 tempOffsetList[len(tempOffsetList) - 1].x2,
    ...
    cv.imwrite("testPic/output.jpeg",outputImage)
    cv.imwrite("testPic/input.jpeg",inputImage)
    cv.imwrite("testPic/src.jpeg",src)
